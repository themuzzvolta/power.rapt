function Get-TemperatureController {
    <#
        .NAME
    ...
    Begin {
        ...
        If ($PSBoundParameters.ContainsKey('Id')){
            $uri = "$($Script:raptObj.baseUri)/api/TemperatureControllers/GetTemperatureController"
        }
        else {
            $uri = "$($Script:raptObj.baseUri)/api/TemperatureControllers/GetTemperatureControllers"
        }
